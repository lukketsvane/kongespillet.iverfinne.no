(()=>{
  ...
  function menuButton(){const mast=document.querySelector('.masthead');if(!mast||mast.querySelector('.fhm-menu-button'))return;const b=document.createElement('button');b.className='fhm-menu-button';b.type='button';b.title='Meny';b.setAttribute('aria-label','Opne meny');b.innerHTML='<svg viewBox="0 0 24 24"><path d="M4 7h16M4 12h16M4 17h16"/></svg>';b.onclick=()=>showMenu(true);mast.appendChild(b)}
  function style(){if(document.getElementById('fhm-style'))return;const s=document.createElement('style');s.id='fhm-style';s.textContent=`
